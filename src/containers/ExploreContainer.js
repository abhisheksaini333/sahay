...
class ExploreContainer extends Component {
  constructor(props) {
    ...
    this.onListingPress = this.onListingPress.bind(this);
    this.onProviderProfileClose = this.onProviderProfileClose.bind(this);
  }
  ...
  onListingPress(listing) {
    ...
    let { favouriteListings } = this.state;
    const index = favouriteListings.indexOf(listing.id);
    navigate('ProviderProfile', { listing, onProviderProfileClose: this.onProviderProfileClose });
    console.log(listing);
  }
  ...
  onProviderProfileClose(listingId) {
    ...
    return listings.map((listing, index) => (
      ...
      >
        <Listings
          ...
          onListingPress={this.onListingPress}
